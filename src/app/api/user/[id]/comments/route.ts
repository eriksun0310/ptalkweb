...
export async function GET(
  ...
  try {
    ...
    // 建立完整的 API URL（使用統一配置的後端 API URL，使用 /api/comment?UserId={id}）
    const apiUrl = `${BACKEND_API_URL}/comment?UserId=${id}&page=${page}&pageSize=${pageSize}&sortBy=${sortBy}&sortOrder=${sortOrder}`;
